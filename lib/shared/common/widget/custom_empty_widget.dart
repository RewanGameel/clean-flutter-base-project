...
class CustomEmptyScreen extends StatelessWidget {
  ...
  const CustomEmptyScreen({required this.title, this.description, this.iconName, this.actionWidget, this.emphasizeSvg, this.emptyScreenTypes});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        if (emptyScreenTypes != null) CustomSvgImage(imageName: emptyScreenTypes == EmptyScreenTypes.emptyList ? Assets.assetsSvgErrorScreen : Assets.assetsSvgErrorScreen),
        Container(
          height: AppSize.s80,
          width: AppSize.s80,
