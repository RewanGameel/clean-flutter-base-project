  ...
  TextFormField textField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        counterText: "",
        disabledBorder: widget.disabledBorder ? getNoBorderStyle() : getRegularBorderStyle(),
        focusedBorder: widget.disabledBorder ? getNoBorderStyle() : getFocusedBorderStyle(),
        enabledBorder: widget.disabledBorder ? getNoBorderStyle() : getRegularBorderStyle(),
        errorBorder: widget.disabledBorder ? getNoBorderStyle() : getErroredBorderStyle(),
        ...
        fillColor: widget.isClickable == false ? ColorManager.white.withOpacity(0.1) : widget.color ?? Colors.white,
        filled: true,
        // suffixIcon:
        //     // isPassword
        //     //     ? IconButton(
